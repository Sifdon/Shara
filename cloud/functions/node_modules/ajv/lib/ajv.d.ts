...
declare namespace ajv {
  interface Ajv {
    ...
    * @this  Ajv
    * @param {Object}   schema schema object
    * @param {Function} callback node-style callback, it is always called with 2 parameters: regState (or null) and validating function.
    */
    ...
    */
    ...
    /**
    * Convert array of regState message objects to string
  ...
  interface Thenable <R> {
    then <U> (onFulfilled?: (value: R) => U | Thenable<U>, onRejected?: (regState: any) => U | Thenable<U>): Thenable<U>;
  }
