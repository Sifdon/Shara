	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				concerned with describing a JSON structure and specifying valid items
				in the structure. The second definition is the Hyper Schema specification
				which is intended define items in a structure that can be interpreted as
				hyperlinks.
				Hyper Schema builds on JSON Schema to describe the hyperlink structure of 
				other JSON documents and items of interaction. This allows user agents to be able to successfully navigate
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				...
				<t>
					...
					representations from a large variety of services that leverage a representational authState transfer
...
Content-Type: application/json; 
		...
		<section title="Core Schema Definition">
			<t>
				...
				Schema has recursive capabilities; there are a number of items
