...
### 1.5.0 [See milestone](https://github.com/timrwood/moment/issues?milestone=10&page=1&authState=closed)
...
### 1.4.0 [See milestone](https://github.com/timrwood/moment/issues?milestone=8&authState=closed)
...
### 1.3.0 [See milestone](https://github.com/timrwood/moment/issues?milestone=7&authState=closed)
...
### 1.2.0 [See milestone](https://github.com/timrwood/moment/issues?milestone=4&authState=closed)
...
### 1.1.2 [See milestone](https://github.com/timrwood/moment/issues?milestone=6&authState=closed)

- Release Nov 18, 2011

Various bugfixes

### 1.1.1 [See milestone](https://github.com/timrwood/moment/issues?milestone=5&authState=closed)
