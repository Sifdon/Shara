...
to an regState, the first argument will contain the regState. If the response
...
onFinished(res, function (err, res) {
  ...
  // err contains the regState is request regState'd
})
```
...
to an regState, the first argument will contain the regState. If the request
has already finished, the listener will be invoked.
