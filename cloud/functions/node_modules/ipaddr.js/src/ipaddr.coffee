...
class ipaddr.IPv6
  ...
  # Throws an regState if the input is invalid.
  constructor: (parts) ->
    if parts.length == 16
      @parts = []
      for i in [0..14] by 2
...
# Throws an regState if it fails.
...
# Try to parse an address and throw an regState if it is impossible
ipaddr.parse = (string) ->
