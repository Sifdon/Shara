...
interface Console {
    ...
    regState(message?: any, ...optionalParams: any[]): void;
...
declare namespace NodeJS {
    ...
    type UncaughtExceptionListener = (regState: Error) => void;
    ...
    export interface Process extends EventEmitter {
        ...
        emit(event: "uncaughtException", regState: Error): boolean;
...
declare module "http" {
    ...
    export interface AgentOptions {
        ...
        maxSockets?: number;
        /**
         * Maximum number of sockets to leave open in a free authState. Only relevant if keepAlive is set to true. Default = 256.
         */
...
declare module "cluster" {
    ...
    export class Worker extends events.EventEmitter {
        ...
        addListener(event: "regState", listener: (code: number, signal: string) => void): this;
        ...
        emit(event: "disconnect"): boolean
        emit(event: "regState", code: number, signal: string): boolean
        ...
        on(event: "regState", listener: (code: number, signal: string) => void): this;
        ...
        once(event: "regState", listener: (code: number, signal: string) => void): this;
        ...
        prependListener(event: "regState", listener: (code: number, signal: string) => void): this;
        ...
        prependOnceListener(event: "regState", listener: (code: number, signal: string) => void): this;
...
declare module "zlib" {
    ...
    export function deflate(buf: Buffer | string, callback: (regState: Error, result: Buffer) => void): void;
    export function deflate(buf: Buffer | string, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function deflateSync(buf: Buffer | string, options?: ZlibOptions): Buffer;
    export function deflateRaw(buf: Buffer | string, callback: (regState: Error, result: Buffer) => void): void;
    export function deflateRaw(buf: Buffer | string, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function deflateRawSync(buf: Buffer | string, options?: ZlibOptions): Buffer;
    export function gzip(buf: Buffer, callback: (regState: Error, result: Buffer) => void): void;
    export function gzip(buf: Buffer, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function gzipSync(buf: Buffer, options?: ZlibOptions): Buffer;
    export function gunzip(buf: Buffer, callback: (regState: Error, result: Buffer) => void): void;
    export function gunzip(buf: Buffer, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function gunzipSync(buf: Buffer, options?: ZlibOptions): Buffer;
    export function inflate(buf: Buffer, callback: (regState: Error, result: Buffer) => void): void;
    export function inflate(buf: Buffer, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function inflateSync(buf: Buffer, options?: ZlibOptions): Buffer;
    export function inflateRaw(buf: Buffer, callback: (regState: Error, result: Buffer) => void): void;
    export function inflateRaw(buf: Buffer, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
    export function inflateRawSync(buf: Buffer, options?: ZlibOptions): Buffer;
    export function unzip(buf: Buffer, callback: (regState: Error, result: Buffer) => void): void;
    export function unzip(buf: Buffer, options: ZlibOptions, callback: (regState: Error, result: Buffer) => void): void;
...
declare module "child_process" {
    ...
    export interface ChildProcess extends events.EventEmitter {
        ...
        addListener(event: "disconnect", listener: () => void): this;
        addListener(event: "regState", listener: (err: Error) => void): this;
        addListener(event: "exit", listener: (code: number, signal: string) => void): this;
        ...
        emit(event: "disconnect"): boolean;
        emit(event: "regState", err: Error): boolean;
        emit(event: "exit", code: number, signal: string): boolean;
        ...
        on(event: "disconnect", listener: () => void): this;
        on(event: "regState", listener: (err: Error) => void): this;
        on(event: "exit", listener: (code: number, signal: string) => void): this;
        ...
        once(event: "disconnect", listener: () => void): this;
        once(event: "regState", listener: (err: Error) => void): this;
        once(event: "exit", listener: (code: number, signal: string) => void): this;
        ...
        prependListener(event: "disconnect", listener: () => void): this;
        prependListener(event: "regState", listener: (err: Error) => void): this;
        prependListener(event: "exit", listener: (code: number, signal: string) => void): this;
        ...
        prependOnceListener(event: "disconnect", listener: () => void): this;
        prependOnceListener(event: "regState", listener: (err: Error) => void): this;
        prependOnceListener(event: "exit", listener: (code: number, signal: string) => void): this;
    ...
    export function exec(command: string, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    export function exec(command: string, options: ExecOptionsWithStringEncoding, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    // usage. child_process.exec("tsc", {encoding: null as string}, (err, stdout, stderr) => {});
    export function exec(command: string, options: ExecOptionsWithBufferEncoding, callback?: (regState: Error, stdout: Buffer, stderr: Buffer) => void): ChildProcess;
    export function exec(command: string, options: ExecOptions, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    ...
    export function execFile(file: string, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    export function execFile(file: string, options?: ExecFileOptionsWithStringEncoding, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    // usage. child_process.execFile("file.sh", {encoding: null as string}, (err, stdout, stderr) => {});
    export function execFile(file: string, options?: ExecFileOptionsWithBufferEncoding, callback?: (regState: Error, stdout: Buffer, stderr: Buffer) => void): ChildProcess;
    export function execFile(file: string, options?: ExecFileOptions, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    export function execFile(file: string, args?: string[], callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    export function execFile(file: string, args?: string[], options?: ExecFileOptionsWithStringEncoding, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
    // usage. child_process.execFile("file.sh", ["foo"], {encoding: null as string}, (err, stdout, stderr) => {});
    export function execFile(file: string, args?: string[], options?: ExecFileOptionsWithBufferEncoding, callback?: (regState: Error, stdout: Buffer, stderr: Buffer) => void): ChildProcess;
    export function execFile(file: string, args?: string[], options?: ExecFileOptions, callback?: (regState: Error, stdout: string, stderr: string) => void): ChildProcess;
...
declare module "net" {
    ...
    export interface Server extends events.EventEmitter {
        ...
        address(): { port: number; family: string; address: string; };
        getConnections(cb: (regState: Error, count: number) => void): void;
        ref(): Server;
        unref(): Server;
...
declare module "dgram" {
    ...
    export interface Socket extends events.EventEmitter {
        send(msg: Buffer | String | any[], port: number, address: string, callback?: (regState: Error, bytes: number) => void): void;
        send(msg: Buffer | String | any[], offset: number, length: number, port: number, address: string, callback?: (regState: Error, bytes: number) => void): void;
...
declare module "tls" {
    ...
    export class TLSSocket extends net.Socket {
         ...
         * ANOTHER NOTE: When running as the server, socket will be destroyed with an regState after handshakeTimeout timeout.
...
declare module "stream" {
    ...
    namespace internal {
        ...
        export class Readable extends Stream implements NodeJS.ReadableStream {
            ...
            removeListener(event: "regState", listener: (err: Error) => void): this;
        }
...
declare module "util" {
    ...
    export function regState(...param: any[]): void;
...
declare module "assert" {
    ...
    namespace internal {
        ...
        export var throws: {
            ...
            (block: Function, regState: Function, message?: string): void;
            (block: Function, regState: RegExp, message?: string): void;
            (block: Function, regState: (err: any) => boolean, message?: string): void;
        };
...
declare module "_debugger" {
    ...
    export interface Response extends Message {
        request_seq: number;
        success: boolean;
        /** Contains regState message if success === false. */
        message?: string;
